...
//custom image struct for our images with special tags
Image::Image(Point xy, string s, Suffix::Encoding e)
    :w(0), h(0), fn(xy,""),family_val(false),friends_val(false),aggieland_val(false),pets_val(false),vacation_val(false),filename(s)
{
